...
export { default as Corporate } from "./recruit/corporate";
export { default as Logistics } from "./recruit/logistics";
export { default as Marketing } from "./recruit/marketing";
export { default as Technology } from "./recruit/technology";
