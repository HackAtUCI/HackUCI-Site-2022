...
const Logistics = () => {
  ...
  return (
    <div className="logistics">
      ...
      <a target="_blank" style={{fontSize:"25px"}} href="https://drive.google.com/file/d/1R7lL-tMOh36qw1JOIam9Ayc4Nzf8V-t5/view?usp=sharing">Click Here for General logistics Deliverable Prompt!</a>
      <br />
