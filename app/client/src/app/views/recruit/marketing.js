  ...
  return (
    <div className="marketing">
      ...
      <div className="marketing-team-img">
        <img alt="marketing Team" src={MarketingImg} width="50%" height="50%" style={{ borderRadius: "25px" }} />
      </div>
      ...
      <a style={{ fontSize: "25px" }} href="https://drive.google.com/file/d/1P37JzKyDyjlizvj4LJfT1HERajLZhR8v/view?usp=sharing">Click Here for General Marketing Deliverable Prompt!</a>
